...
from envs.vec_env.pytorch_vec_env import VecPyTorch
from envs.vec_env.subproc_vec_env import SubprocVecEnv
from envs.vec_env.vec_normalize import VecNormalize
...
def make_vec_envs(
    ...
    envs = [
        make_env(cfg.ENV_NAME, seed, idx, xml_file=xml_file) for idx in range(num_env)
    ]
    ...
    envs = VecNormalize(envs, gamma=cfg.PPO.GAMMA, training=training, ret=norm_rew)
