...
from utils import spaces as spu
...
class HfieldObs2D(gym.Wrapper):
    ...
    def _add_hfield_obs(self, obs, info):
        ...
        try:
            ...
            exu.handle_exception(e, "ERROR in Hfield: {}".format(uid), unimal_id=uid)
    ...
    def _get_corner_points(self, mask_row, mask_col):
        ...
        for name, point in zip(names, corner_points):
            ...
            x_pos, y_pos = self.unwrapped.modules[terrain_module].idx_to_pos([row, col])
