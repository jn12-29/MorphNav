...
CUDA_VISIBLE_DEVICES=0 python ./rl-baselines3-zoo/train.py --algo ppo_lstm --env PointMaze -conf ./rl-baselines3-zoo/conf/maze.yml --vec-env subproc -P --tensorboard-log ./logs --eval-freq 10_000 --eval-episodes 32 --n-eval-envs 8 --save-freq 100_000 --env-kwargs continuing_task:False cur_pos_aware:False target_aware:False sensor_aware:False maze_map_name:"'U_MAZE'" xml_file_path:"'/home/xh/ai4neuron/MorphNav/envs/assets/point_v1.xml'" success_radius:0.45 --hyperparams n_timesteps:1e7

CUDA_VISIBLE_DEVICES=1 python ./rl-baselines3-zoo/train.py --algo ppo_lstm --env PointMaze -conf ./rl-baselines3-zoo/conf/maze.yml --vec-env subproc -P --tensorboard-log ./logs --eval-freq 10_000 --eval-episodes 32 --n-eval-envs 8 --save-freq 100_000 --env-kwargs continuing_task:False cur_pos_aware:False target_aware:False sensor_aware:False maze_map_name:"'U_MAZE'" xml_file_path:"'/home/xh/ai4neuron/MorphNav/envs/assets/point_v1.xml'" success_radius:0.2 --hyperparams n_timesteps:1e7

CUDA_VISIBLE_DEVICES=2 python ./rl-baselines3-zoo/train.py --algo ppo_lstm --env PointMaze -conf ./rl-baselines3-zoo/conf/maze.yml --vec-env subproc -P --tensorboard-log ./logs --eval-freq 10_000 --eval-episodes 32 --n-eval-envs 8 --save-freq 100_000 --env-kwargs continuing_task:False cur_pos_aware:False target_aware:False sensor_aware:False maze_map_name:"'U_MAZE'" xml_file_path:"'/home/xh/ai4neuron/MorphNav/envs/assets/point_v1.xml'" success_radius:0.3 --hyperparams n_timesteps:1e7
...
CUDA_VISIBLE_DEVICES=7 python ./rl-baselines3-zoo/train.py --algo ppo_lstm --env PointMaze -conf ./rl-baselines3-zoo/conf/maze.yml --vec-env subproc -P --tensorboard-log ./logs --eval-freq 10_000 --eval-episodes 32 --n-eval-envs 8 --save-freq 100_000 --env-kwargs continuing_task:True cur_pos_aware:False target_aware:False sensor_aware:False maze_map_name:"'OPEN'" xml_file_path:"'/home/xh/ai4neuron/MorphNav/envs/assets/point_v1.xml'" success_radius:0.2 --hyperparams n_timesteps:1e7

# 20260312 PointMaze EMPTY
CUDA_VISIBLE_DEVICES=0 python ./rl-baselines3-zoo/train.py --algo ppo_lstm --env PointMaze -conf ./rl-baselines3-zoo/conf/maze.yml --vec-env subproc -P --tensorboard-log ./logs --eval-freq 10_000 --eval-episodes 32 --n-eval-envs 8 --save-freq 100_000 --env-kwargs continuing_task:False cur_pos_aware:False target_aware:True sensor_aware:False start_pos_aware:True maze_map_name:"'OPEN'" xml_file_path:"'/home/xh/ai4neuron/MorphNav/envs/assets/point_v1.xml'" success_radius:0.4 --hyperparams n_timesteps:1e7

CUDA_VISIBLE_DEVICES=3 python ./rl-baselines3-zoo/train.py --algo ppo_lstm --env PointMaze -conf ./rl-baselines3-zoo/conf/maze.yml --vec-env subproc -P --tensorboard-log ./logs --eval-freq 10_000 --eval-episodes 32 --n-eval-envs 8 --save-freq 100_000 --env-kwargs continuing_task:True cur_pos_aware:False target_aware:True sensor_aware:False start_pos_aware:True maze_map_name:"'OPEN'" xml_file_path:"'/home/xh/ai4neuron/MorphNav/envs/assets/point_v1.xml'" success_radius:0.4 --hyperparams n_timesteps:1e7
